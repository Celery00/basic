const citys = [
	...
	[
		...
		[
			...
			['桥东区', '桥西区', '宣化区', '下花园区', '万全区', '崇礼区', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '怀来县', '涿鹿县', '赤城县', '张家口市高新技术产业开发区', '张家口市察北管理区', '张家口市塞北管理区'],
			['双桥区', '双滦区', '鹰手营子矿区', '承德县', '兴隆县', '滦平县', '隆化县', '丰宁满族自治县', '宽城满族自治县', '围场满族蒙古族自治县', '承德高新技术产业开发区', '平泉市'],
			['新华区', '运河区', '沧县', '青县', '东光县', '海兴县', '盐山县', '肃宁县', '南皮县', '吴桥县', '献县', '孟村回族自治县', '河北沧州经济开发区', '沧州高新技术产业开发区', '沧州渤海新区', '泊头市', '任丘市', '黄骅市', '河间市'],
			['安次区', '广阳区', '固安县', '永清县', '香河县', '大城县', '文安县', '大厂回族自治县', '廊坊经济技术开发区', '霸州市', '三河市'],
			['桃城区', '冀州区', '枣强县', '武邑县', '武强县', '饶阳县', '安平县', '故城县', '景县', '阜城县', '河北衡水经济开发区', '衡水滨湖新区', '深州市']
		],
		[
			['小店区', '迎泽区', '杏花岭区', '尖草坪区', '万柏林区', '晋源区', '清徐县', '阳曲县', '娄烦县', '山西转型综合改革示范区', '古交市'],
			['城区', '矿区', '南郊区', '新荣区', '阳高县', '天镇县', '广灵县', '灵丘县', '浑源县', '左云县', '大同县', '山西大同经济开发区'],
		...
		[
			['南关区', '宽城区', '朝阳区', '二道区', '绿园区', '双阳区', '九台区', '农安县', '长春经济技术开发区', '长春净月高新技术产业开发区', '长春高新技术产业开发区', '长春汽车经济技术开发区', '榆树市', '德惠市'],
			['昌邑区', '龙潭区', '船营区', '丰满区', '永吉县', '吉林经济开发区', '吉林高新技术产业开发区', '吉林中国新加坡食品区', '蛟河市', '桦甸市', '舒兰市', '磐石市'],
		...
		[
			...
			['鼓楼区', '云龙区', '贾汪区', '泉山区', '铜山区', '丰县', '沛县', '睢宁县', '徐州经济技术开发区', '新沂市', '邳州市'],
			['天宁区', '钟楼区', '新北区', '武进区', '金坛区', '溧阳市'],
			['虎丘区', '吴中区', '相城区', '姑苏区', '吴江区', '苏州工业园区', '常熟市', '张家港市', '昆山市', '太仓市'],
			['崇川区', '港闸区', '通州区', '海安县', '如东县', '南通经济技术开发区', '启东市', '如皋市', '海门市'],
			['连云区', '海州区', '赣榆区', '东海县', '灌云县', '灌南县', '连云港经济技术开发区', '连云港高新技术产业开发区'],
			['淮安区', '淮阴区', '清江浦区', '洪泽区', '涟水县', '盱眙县', '金湖县', '淮安经济技术开发区'],
			['亭湖区', '盐都区', '大丰区', '响水县', '滨海县', '阜宁县', '射阳县', '建湖县', '盐城经济技术开发区', '东台市'],
			['广陵区', '邗江区', '江都区', '宝应县', '扬州经济技术开发区', '仪征市', '高邮市'],
			['京口区', '润州区', '丹徒区', '镇江新区', '丹阳市', '扬中市', '句容市'],
		...
		[
			...
			['镜湖区', '弋江区', '鸠江区', '三山区', '芜湖县', '繁昌县', '南陵县', '无为县', '芜湖经济技术开发区', '安徽芜湖长江大桥经济开发区'],
			...
			['琅琊区', '南谯区', '来安县', '全椒县', '定远县', '凤阳县', '苏滁现代产业园', '滁州经济技术开发区', '天长市', '明光市'],
			['颍州区', '颍东区', '颍泉区', '临泉县', '太和县', '阜南县', '颍上县', '阜阳合肥现代产业园区', '阜阳经济技术开发区', '界首市'],
			['桥区', '砀山县', '萧县', '灵璧县', '泗县', '宿州马鞍山现代产业园区', '宿州经济技术开发区'],
		...
		[
			...
			['鲤城区', '丰泽区', '洛江区', '泉港区', '惠安县', '安溪县', '永春县', '德化县', '石狮市', '晋江市', '南安市'],
		...
		[
			['历下区', '市中区', '槐荫区', '天桥区', '历城区', '长清区', '章丘区', '平阴县', '济阳县', '商河县', '济南高新技术产业开发区'],
			['市南区', '市北区', '黄岛区', '崂山区', '李沧区', '城阳区', '即墨区', '青岛高新技术产业开发区', '胶州市', '平度市', '莱西市'],
			['淄川区', '张店区', '博山区', '临淄区', '周村区', '桓台县', '高青县', '沂源县'],
			['市中区', '薛城区', '峄城区', '台儿庄区', '山亭区', '滕州市'],
			['东营区', '河口区', '垦利区', '利津县', '广饶县', '东营经济技术开发区', '东营港经济开发区'],
			['芝罘区', '福山区', '牟平区', '莱山区', '长岛县', '烟台高新技术产业开发区', '烟台经济技术开发区', '龙口市', '莱阳市', '莱州市', '蓬莱市', '招远市', '栖霞市', '海阳市'],
		...
		[
			...
			['老城区', '西工区', 'e河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '洛阳高新技术产业开发区', '偃师市'],
			...
			['负忧', '平桥区', '罗山县', '光山县', '新县', '商城县', '固始县', '潢川县', '淮滨县', '息县', '信阳高新技术产业开发区'],
			['川汇区', '扶沟县', '西华县', '商水县', '沈丘县', '郸城县', '淮阳县', '太康县', '鹿邑县', '河南周口经济开发区', '项城市'],
			['驿城区', '西平县', '上蔡县', '平舆县', '正阳县', '确山县', '泌阳县', '汝南县', '遂平县', '新蔡县', '河南驻马店经济开发区'],
			['济源市']
		],
		[
			['江岸区', '江汉区', '~口区', '汉阳区', '武昌区', '青山区', '洪山区', '东西湖区', '汉南区', '蔡甸区', '江夏区', '黄陂区', '新洲区'],
			['黄石港区', '西塞山区', '下陆区', '铁山区', '阳新县', '大冶市'],
			['茅箭区', '张湾区', '郧阳区', '郧西县', '竹山县', '竹溪县', '房县', '丹江口市'],
			['西陵区', '伍家岗区', '点军区', 'V亭区', '夷陵区', '远安县', '兴山县', '秭归县', '长阳土家族自治县', '五峰土家族自治县', '宜都市', '当阳市', '枝江市'],
		...
		[
			...
			['东城街道办事处', '南城街道办事处', '万江街道办事处', '莞城街道办事处', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '樟木头镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道蛘', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇', '高墩', '松山湖管委会', '东莞港', '东莞生态园'],
		...
		[
			['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '金堂县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市', '简阳市'],
